...
var ENERMY_X = -90;
var PLAYER_Y = 404;
var ENERMY_BLOCK_X = 101;
var ENERMY_BLOCK_Y = 83;
var MIN_LEFT = 0;
var MAX_RIGHT = 400;
var MIN_UP = 70;
var MAX_BOTTOM= 404;
...
var Enemy = function() {
    ...
    this.x = ENERMY_X;
    //call getRandom() to get random speed - 50 slowest and 100 fastest
    this.speed = getRandom(150, 80);
}
...
var enermiesInterval = setInterval(getEnermies, 3000);
...
var Player = function() {
    ...
    this.xBlock = ENERMY_BLOCK_X;
    this.yBlock = ENERMY_BLOCK_Y;
    //Player starting position
    this.x = ENERMY_BLOCK_X * 2;
    this.y = PLAYER_Y;
}
